// Author: Kevin Ufkes
// Date: June 3, 2021
// Project: Daily Coding Problem of May 30, 2021
// Description:
...
public class Main {
    ...
    public static int problemSolver01(int n){
        if(n==0){
            return 1;
        }
        if(n==1){
        ...
        return problemSolver01(n-2) + problemSolver01(n-1);
    }

    public static void main(String[] args) {
        System.out.println(problemSolver01(5));
    }
}
